...
$html .= '
<div style="position: absolute; left: 50px; top: 28px; z-index: 1;"><img src="'.$ruta_images_imagenesPdf.'/SDG_es/'.$depende[0].'_es.png" width="63" height="63"></div>';
}
...
$html .= '
<div style="position: absolute; left: 50px; top: 28px; z-index: 1;"><img src="'.$ruta_images_imagenesPdf.'/SDG_es/'.$depende[0].'_es.png" width="63" height="63"></div>
<div style="position: absolute; left: 150px; top: 28px; z-index: 2;"><img src="'.$ruta_images_imagenesPdf.'/SDG_es/'.$depende[1].'_es.png" width="63" height="63"></div>
';
}
...
$html .= '
<div style="position: absolute; left: 27px; top: 28px; z-index: 1;"><img src="'.$ruta_images_imagenesPdf.'/SDG_es/'.$depende[0].'_es.png" width="63" height="63"></div>
<div style="position: absolute; left: 100px; top: 28px; z-index: 2;"><img src="'.$ruta_images_imagenesPdf.'/SDG_es/'.$depende[1].'_es.png" width="63" height="63"></div>
<div style="position: absolute; left: 174px; top: 28px; z-index: 3;"><img src="'.$ruta_images_imagenesPdf.'/SDG_es/'.$depende[2].'_es.png" width="63" height="63"></div>
';
}
...
<tr>
<td align="center">
<div style="position: absolute; left: 0px; top: 41px; z-index: 1;"><img src="'.$grafica_radial.'" width="542.5" height="558.5"></div>
<div id="contenedor-imagen" style="position: absolute; left: 0px; top: 35px; z-index: 1;"><img src="'.$ruta_images_imagenesPdf.'/GRadial_es.jpg" width="542" height="530"></div>
...
<tr>';
	...
	$filename = $qrcode.'QR_'.$id_post.'_ALINEACION_ES.png';
	...
	$contenido = $actual_link."/observatorio/fichas/create_pdf_3.php?p=".encripta($id_post)."&f=". encripta($id_ficha_sostenibilidad)."&l=ES"; //Texto
	
    //Enviamos los parametros a la Funcion para generar codigo QR 
	QRcode::png($contenido, $filename, $level, $tamao, $framSize);

    $qr_alineacion_name = 'QR_'.$id_post.'_ALINEACION_ES.png';
    $QR_alineacion_meta_atributo = $_SERVER["DOCUMENT_ROOT"].'/observatorio/fichas/QR/'.'QR_'.$id_post.'_ALINEACION_ES.png';
...
<tr>
<td align="center"> 
<div style="margin-top:16px;padding-right:12px">'.$textoPDF_f.'</div>
</td>
</tr>
...
<div class="table">
<div class="col-12 table-row">
<div style="padding-left:4px !important; padding-right:9px !important; margin-top:160px !important">'.$textoPDF_g.'</div>
</div>
</div>
